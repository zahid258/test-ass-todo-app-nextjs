...
import { IToDoRequest, IToDoResponse, IUserResponse, TaskStatus, taskStatuses } from "@/models";
...
const UserItem: React.FC<{ singleUser: IUserResponse }> = ({ singleUser }) => {
  ...
  return (
    <>
      ...
      >
        <div>
          <h3 className="text-lg font-bold">{singleUser.userName}</h3>
          ...
          <div className="flex gap-2 justify-end p-2">
            <div onClick={() => setIsOpen(true)}>
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="size-6 cursor-pointer w-5"
              >
                <path
            ...
            <div onClick={() => handleDelete(singleUser?.id)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
